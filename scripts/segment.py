...
def segment(foldername, bookname):
    ...
    with open("././public/uploads/{}/EPUB/Content/{}.xhtml".format(foldername, bookname + "_clean"), "r", encoding="utf8") as f:
        text = f.read()
    ...
    if not os.path.exists("././public/uploads/{}/EPUB/Content/segments/".format(foldername)):
        os.makedirs("././public/uploads/{}/EPUB/Content/segments/".format(foldername))

    for i, segment in enumerate(segments[1:]):
        with open("././public/uploads/{}/EPUB/Content/segments/b{}.xhtml".format(foldername, i + 1), "w", encoding="utf8") as f:
